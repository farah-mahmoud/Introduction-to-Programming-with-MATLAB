...
% A possible way to represent a sparse matrix is with a cell vector
% whose first element is a 2-element vector representing the size of the sparse matrix. 
...
% as defined above and returns the output argument called matrix, 
...
i = 3;
for i = 3:n
    p{cellvec{1, i}(1, 1), cellvec{1, i}(1, 2)} = cellvec{1, i}(1, 3);
end
matrix = cell2mat(p);
